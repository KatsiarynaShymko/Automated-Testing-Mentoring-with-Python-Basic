...
class Employee(ABC):
    ...
    def leave_company(self):
        ...
        if self.company is None:
            return "Employee is not currently employed by any company"
        else:
            self.company.fire(self)
            return "Employee left the company"
...
class Company:
    ...
    def hire(self, employee: Employee):
        ...
        if employee.company is not None:
            return "Employee is already hired"
        elif employee in self.employees:
            return "Employee is already added to the list"
        else:
    ...
    def raise_pay(self, employee: Employee, amount):
        """
    ...
    def __repr__(self):
        ...
        """
        return f"Company: {self.name}, {self.domain}, Employees: {len(self.employees)}"
...
print(company1.raise_pay(employee3, 15))
